...
% parse the inputs
    ...
    for gnum = p.Results.gates
        ...
        EfViClean.gatesClean = p.Results.gates;
        EfViClean.stdlimClean = p.Results.stdlim;
        EfViClean.corrlimClean = p.Results.corrlim;
        EfViClean.chisqrlimClean = p.Results.chisqrlim;
